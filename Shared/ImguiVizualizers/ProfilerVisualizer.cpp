...
namespace Profiler {
    ...
    void ProfilerVisualizer::CaptureMouseWheel()
    {
        ...
        if (ImGui::IsKeyDown(ImGuiMod_Ctrl) && ImGui::IsWindowHovered(ImGuiHoveredFlags_ChildWindows))
        {
    ...
    void ProfilerVisualizer::RenderFlameGraph()
    {
        ...
        {
            // Capture mouse wheel here, inside the child window where
            // IsWindowHovered will correctly refer to the flame graph region.
            CaptureMouseWheel();
