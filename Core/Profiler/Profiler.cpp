#include "Profiler.h"
#include "ProfilerAnalyzer.h"  // Include for direct transfer
#include <iostream>
#include <iomanip>
#include <sstream>
...
namespace Profiler {
	...
	std::string ProfileLogger::SerializeRecentEvents() {
        ...
        m_serializeIndex = m_events.size(); // Update index to mark all events as serialized
		...
		{
            result.clear(); // or handle error as needed
        }
		return result;
	}
