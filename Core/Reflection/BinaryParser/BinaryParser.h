...
/** @brief Binary file parser implementing the IRFL_Parser interface. */
class CRFL_BinaryParser : public IRFL_Parser
{
public:

    void ReadFloat(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
            ReadRaw(property, obj);
    }
    void ReadInt(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
            ReadRaw(property, obj);
    }
    void ReadString(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
    ...
    void ReadMatrix4(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
            ReadRaw(property, obj);
    }
    void ReadVector4(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
            ReadRaw(property, obj);
    }
    void ReadVector3(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
            ReadRaw(property, obj);
    }
    void ReadObject(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
    ...
    void ReadObjectPtr(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
    ...
    void ReadObjectPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteFloat(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        WriteRaw(property, obj);
    }
    void WriteInt(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        WriteRaw(property, obj);
    }
    void WriteString(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::string* string = reinterpret_cast<std::string*>(property.GetAddress(obj));
        WriteString(*string);
    }
    void WriteMatrix4(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        WriteRaw(property, obj);
    }
    void WriteVector4(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        WriteRaw(property, obj);
    }
    void WriteVector3(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        WriteRaw(property, obj);
    }
    void WriteObject(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        CReflectedBase* subObj = reinterpret_cast<CReflectedBase*>(property.GetAddress(obj));
        subObj->WriteMembers(*this);
    }
    void WriteObjectPtr(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::unique_ptr<CReflectedBase>* subObjPtr =
            reinterpret_cast<std::unique_ptr<CReflectedBase>*>(property.GetAddress(obj));
    ...
    void WriteObjectPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<std::unique_ptr<CReflectedBase>>* objVector =
            reinterpret_cast<std::vector<std::unique_ptr<CReflectedBase>>*>(property.GetAddress(obj));
    ...
    bool BeginOutput(const std::string& fileName) override
    {
    ...
    bool BeginInput(const std::string& fileName) override
    {
        auto* fileSystemManager = Core::CoreSystem::GetFileSystemManager();
        if (!fileSystemManager)
        {
    ...
    void BeginObject(const char* className = "") override {}
    void EndObject(const char* memberName) override {}
    ...
    bool WriteProperties(const CPropertyBase& property) override
    {
    ...
    void ReadComponent(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
    ...
    void ReadComponentPtr(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            std::string className;
    ...
    void ReadComponentPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
            ...
            componentVector->reserve(arraySize);
    ...
    void WriteComponent(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        ComponentSystem::Component* subObj = reinterpret_cast<ComponentSystem::Component*>(property.GetAddress(obj));
        subObj->WriteMembers(*this);
    ...
    void WriteComponentPtr(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::unique_ptr<ComponentSystem::Component>* subObjPtr =
            reinterpret_cast<std::unique_ptr<ComponentSystem::Component>*>(property.GetAddress(obj));
    ...
    void WriteComponentPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<std::unique_ptr<ComponentSystem::Component>>* componentVector =
            reinterpret_cast<std::vector<std::unique_ptr<ComponentSystem::Component>>*>(property.GetAddress(obj));
    ...
    void ReadComponentRawPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteComponentRawPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<ComponentSystem::Component*>* componentVector =
            reinterpret_cast<std::vector<ComponentSystem::Component*>*>(property.GetAddress(obj));
    ...
    void ReadComponentSharedPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteComponentSharedPtrArray(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<std::shared_ptr<ComponentSystem::Component>>* componentVector =
            reinterpret_cast<std::vector<std::shared_ptr<ComponentSystem::Component>>*>(property.GetAddress(obj));
    ...
    void ReadBool(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
    ...
    void WriteBool(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        bool* value = reinterpret_cast<bool*>(property.GetAddress(obj));
        char raw = *value ? 1 : 0;
    ...
    void ReadIntVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteIntVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<int>* vec = reinterpret_cast<std::vector<int>*>(property.GetAddress(obj));
    ...
    void ReadFloatVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteFloatVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<float>* vec = reinterpret_cast<std::vector<float>*>(property.GetAddress(obj));
        WriteInt(static_cast<int>(vec->size()));
    ...
    void ReadBoolVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteBoolVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<bool>* vec = reinterpret_cast<std::vector<bool>*>(property.GetAddress(obj));
        WriteInt(static_cast<int>(vec->size()));
    ...
    void ReadStringVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int arraySize;
    ...
    void WriteStringVector(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::vector<std::string>* vec = reinterpret_cast<std::vector<std::string>*>(property.GetAddress(obj));
        WriteInt(static_cast<int>(vec->size()));
    ...
    void ReadStringBoolMap(const CPropertyBase& property, CReflectedBase* obj) override
    {
        if (ValidateProperties(property))
        {
            int mapSize;
    ...
    void WriteStringBoolMap(const CPropertyBase& property, CReflectedBase* obj) override
    {
        WriteProperties(property);
        std::unordered_map<std::string, bool>* map =
            reinterpret_cast<std::unordered_map<std::string, bool>*>(property.GetAddress(obj));
