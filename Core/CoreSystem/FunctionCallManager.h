...
namespace FunctionCall {
    ...
    // Result wrapper for function call results
    template<typename T>
    class CallResult {
    private:
        T m_value;
    ...
    public:
        ...
        CallResult(const T& value) : m_value(value), m_hasValue(true) {}
        CallResult(const std::string& error) : m_error(error), m_hasValue(false) {}
    ...
    public:
        ...
        CallResult(const std::string& error) : m_error(error), m_success(false) {}
    ...
    // Function wrapper for different function signatures
    ...
    public:
        ...
        std::string GetSignature() const override {
            ...
            if (!m_paramNames.empty()) {
                ...
                // Generate parameter names based on types
    ...
    // String parser for function calls
    ...
    public:
        FunctionCallManager(bool caseSensitive = true) : m_caseSensitive(caseSensitive) {}
        ...
        // Call a function by parsing a string
        ...
        // Call a function by name and parameters
        template<typename ReturnType = void>
